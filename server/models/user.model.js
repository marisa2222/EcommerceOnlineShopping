...
const userSchema = new mongoose.Schema(
	{
		...
		phone: {
			type: String,
			required: [false, 'Please, provide your phone number, i.e.: +491xxxxxxxxxx'],
			validate: {
				validator: value => validator.isMobilePhone(value, 'de-DE', { strictMode: true }),
				message: 'Phone number {VALUE} is not valid. Please, retry like +491xxxxxxxxxx'
			}
		},
